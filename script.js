...
function upadatePaddle1() {
  if (keysPressed["w"]) {
    ...
    if (paddle1Speed > 0) {
      paddle1Speed = Math.max(paddle1Speed - paddleDecleration, 0);
    }
    if (paddle1Speed < 0) {
      paddle1Speed = Math.min(paddle1Speed + paddleDecleration, 0);
    }
  }
...
function upadatePaddle2() {
  if (keysPressed["ArrowUp"]) {
    ...
    if (paddle2Speed > 0) {
      paddle2Speed = Math.max(paddle2Speed - paddleDecleration, 0);
    }
    if (paddle2Speed < 0) {
      paddle2Speed = Math.min(paddle2Speed + paddleDecleration, 0);
    }
  }
